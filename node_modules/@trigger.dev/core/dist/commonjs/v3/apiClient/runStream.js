...
exports.RunSubscription = exports.ElectricStreamSubscription = exports.SSEStreamSubscriptionFactory = exports.SSEStreamSubscription = void 0;
...
// Real implementation for production
class ElectricStreamSubscription {
    url;
    options;
    constructor(url, options) {
        this.url = url;
    ...
    async subscribe() {
        return (0, stream_js_1.zodShapeStream)(api_js_1.SubscribeRealtimeStreamChunkRawShape, this.url, this.options)
            .stream.pipeThrough(new TransformStream({
            transform(chunk, controller) {
                controller.enqueue(chunk.value);
            },
        }))
            .pipeThrough(new stream_js_1.LineTransformStream())
            .pipeThrough(new TransformStream({
            transform(chunk, controller) {
...
exports.ElectricStreamSubscription = ElectricStreamSubscription;
