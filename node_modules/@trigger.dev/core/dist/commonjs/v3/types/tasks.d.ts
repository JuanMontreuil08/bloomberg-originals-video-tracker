...
export type TaskOptionsWithSchema<TIdentifier extends string, TOutput = unknown, TInitOutput extends InitOutput = any> = CommonTaskOptions<TIdentifier, any, TOutput, TInitOutput> & {
    jsonSchema: JSONSchema;
};
...
export interface Task<TIdentifier extends string, TInput = void, TOutput = any> {
     ...
     * ```
     */
    batchTriggerAndWait: (items: Array<BatchTriggerAndWaitItem<TInput>>, options?: BatchTriggerAndWaitOptions) => Promise<BatchResult<TIdentifier, TOutput>>;
}
