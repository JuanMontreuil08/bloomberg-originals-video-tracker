...
export type OnInitHookFunction<TPayload, TInitOutput extends TaskInitOutput> = (params: TaskInitHookParams<TPayload>) => TInitOutput | undefined | void | Promise<TInitOutput | undefined | void>;
export type AnyOnInitHookFunction = OnInitHookFunction<unknown, TaskInitOutput>;
export type TaskStartHookParams<TPayload = unknown, TInitOutput extends TaskInitOutput = TaskInitOutput> = {
    ctx: TaskRunContext;
    payload: TPayload;
    task: string;
    signal: AbortSignal;
...
export type OnStartHookFunction<TPayload, TInitOutput extends TaskInitOutput = TaskInitOutput> = (params: TaskStartHookParams<TPayload, TInitOutput>) => undefined | void | Promise<undefined | void>;
...
export type TaskWaitHookParams<TPayload = unknown, TInitOutput extends TaskInitOutput = TaskInitOutput> = {
    wait: TaskWait;
    ctx: TaskRunContext;
    payload: TPayload;
    task: string;
...
export type OnWaitHookFunction<TPayload, TInitOutput extends TaskInitOutput = TaskInitOutput> = (params: TaskWaitHookParams<TPayload, TInitOutput>) => undefined | void | Promise<undefined | void>;
export type AnyOnWaitHookFunction = OnWaitHookFunction<unknown, TaskInitOutput>;
export type TaskResumeHookParams<TPayload = unknown, TInitOutput extends TaskInitOutput = TaskInitOutput> = {
    ctx: TaskRunContext;
    wait: TaskWait;
    payload: TPayload;
    task: string;
...
export type OnResumeHookFunction<TPayload, TInitOutput extends TaskInitOutput = TaskInitOutput> = (params: TaskResumeHookParams<TPayload, TInitOutput>) => undefined | void | Promise<undefined | void>;
export type AnyOnResumeHookFunction = OnResumeHookFunction<unknown, TaskInitOutput>;
export type TaskFailureHookParams<TPayload = unknown, TInitOutput extends TaskInitOutput = TaskInitOutput> = {
    ctx: TaskRunContext;
    payload: TPayload;
    task: string;
    error: unknown;
...
export type OnFailureHookFunction<TPayload, TInitOutput extends TaskInitOutput = TaskInitOutput> = (params: TaskFailureHookParams<TPayload, TInitOutput>) => undefined | void | Promise<undefined | void>;
export type AnyOnFailureHookFunction = OnFailureHookFunction<unknown, TaskInitOutput>;
export type TaskSuccessHookParams<TPayload = unknown, TOutput = unknown, TInitOutput extends TaskInitOutput = TaskInitOutput> = {
    ctx: TaskRunContext;
    payload: TPayload;
    task: string;
    output: TOutput;
...
export type OnSuccessHookFunction<TPayload, TOutput, TInitOutput extends TaskInitOutput = TaskInitOutput> = (params: TaskSuccessHookParams<TPayload, TOutput, TInitOutput>) => undefined | void | Promise<undefined | void>;
...
export type TaskCompleteResult<TOutput> = TaskCompleteSuccessResult<TOutput> | TaskCompleteErrorResult;
export type TaskCompleteHookParams<TPayload = unknown, TOutput = unknown, TInitOutput extends TaskInitOutput = TaskInitOutput> = {
    ctx: TaskRunContext;
    payload: TPayload;
    task: string;
...
export type OnCompleteHookFunction<TPayload, TOutput, TInitOutput extends TaskInitOutput = TaskInitOutput> = (params: TaskCompleteHookParams<TPayload, TOutput, TInitOutput>) => undefined | void | Promise<undefined | void>;
...
export type TaskCatchErrorHookParams<TPayload = unknown, TInitOutput extends TaskInitOutput = TaskInitOutput> = {
    ctx: TaskRunContext;
    payload: TPayload;
    task: string;
    error: unknown;
...
export type OnCatchErrorHookFunction<TPayload, TInitOutput extends TaskInitOutput = TaskInitOutput> = (params: TaskCatchErrorHookParams<TPayload, TInitOutput>) => HandleErrorResult;
...
export type OnMiddlewareHookFunction<TPayload> = (params: TaskMiddlewareHookParams<TPayload>) => Promise<void>;
export type AnyOnMiddlewareHookFunction = OnMiddlewareHookFunction<unknown>;
export type TaskCleanupHookParams<TPayload = unknown, TInitOutput extends TaskInitOutput = TaskInitOutput> = {
    ctx: TaskRunContext;
    payload: TPayload;
    task: string;
    signal: AbortSignal;
...
export type OnCleanupHookFunction<TPayload, TInitOutput extends TaskInitOutput = TaskInitOutput> = (params: TaskCleanupHookParams<TPayload, TInitOutput>) => undefined | void | Promise<undefined | void>;
export type AnyOnCleanupHookFunction = OnCleanupHookFunction<unknown, TaskInitOutput>;
export type TaskCancelHookParams<TPayload = unknown, TRunOutput = any, TInitOutput extends TaskInitOutput = TaskInitOutput> = {
    ctx: TaskRunContext;
    payload: TPayload;
    task: string;
...
export type OnCancelHookFunction<TPayload, TRunOutput = any, TInitOutput extends TaskInitOutput = TaskInitOutput> = (params: TaskCancelHookParams<TPayload, TRunOutput, TInitOutput>) => undefined | void | Promise<undefined | void>;
