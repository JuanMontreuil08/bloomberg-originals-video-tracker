import { z } from "zod";
import { WorkloadHeartbeatResponseBody, WorkloadRunAttemptCompleteResponseBody, WorkloadRunAttemptStartResponseBody, WorkloadRunLatestSnapshotResponseBody, WorkloadDequeueFromVersionResponseBody, WorkloadSuspendRunResponseBody, WorkloadContinueRunExecutionResponseBody, WorkloadRunSnapshotsSinceResponseBody, } from "./schemas.js";
...
export class WorkloadHttpClient {
    ...
    async getRunExecutionData(runId) {
        return wrapZodFetch(WorkloadRunLatestSnapshotResponseBody, `${this.apiUrl}/api/v1/workload-actions/runs/${runId}/snapshots/latest`, {
            method: "GET",
            headers: {
                ...this.defaultHeaders(),
            },
