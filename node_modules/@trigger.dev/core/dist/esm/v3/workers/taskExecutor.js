...
import { accessoryAttributes, attemptKey, flattenAttributes, lifecycleHooks, OTEL_SPAN_ATTRIBUTE_COUNT_LIMIT, runMetadata, traceContext, waitUntil, } from "../index.js";
            ...
            for (const hook of globalInitHooks) {
                const [hookError, result] = await tryCatch(this._tracer.startActiveSpan("init()", async (span) => {
                    ...
                    if (result && typeof result === "object" && !Array.isArray(result)) {
                        span.setAttributes(flattenAttributes(result, undefined, OTEL_SPAN_ATTRIBUTE_COUNT_LIMIT));
                        return result;
                    }
                    return {};
                }, {
