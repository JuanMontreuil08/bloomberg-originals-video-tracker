...
export class WarmStartClient {
    opts;
    logger = new SimpleStructuredLogger("warm-start-client");
    apiUrl;
    backoff = new ExponentialBackoff("FullJitter");
    get connectUrl() {
    ...
    async connect() {
        return wrapZodFetch(WarmStartConnectResponse, this.connectUrl.href, {
            method: "GET",
            headers: {
