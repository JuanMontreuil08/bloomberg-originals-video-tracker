import { accessoryAttributes, apiClientManager, flattenAttributes, mergeRequestOptions, } from "@trigger.dev/core/v3";
 ...
 */
export function retrieve(queue, requestOptions) {
    const apiClient = apiClientManager.clientOrThrow();
    const $requestOptions = mergeRequestOptions({
        tracer,
 ...
 */
export function pause(queue, requestOptions) {
    const apiClient = apiClientManager.clientOrThrow();
    const $requestOptions = mergeRequestOptions({
        tracer,
        name: "queues.pause()",
 ...
 * @returns The updated queue state
 */
export function resume(queue, requestOptions) {
    const apiClient = apiClientManager.clientOrThrow();
    const $requestOptions = mergeRequestOptions({
        tracer,
        name: "queues.resume()",
